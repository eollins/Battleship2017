USE [master]
GO
/****** Object:  Database [EthanOllinsBattleships2017]    Script Date: 6/29/2017 11:13:10 AM ******/
...
GO
/****** Object:  User [EthanOllinsAppUser]    Script Date: 6/29/2017 11:13:10 AM ******/
CREATE USER [EthanOllinsAppUser] FOR LOGIN [EthanOllinsAppUser] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  User [EthanOllins]    Script Date: 6/29/2017 11:13:10 AM ******/
CREATE USER [EthanOllins] FOR LOGIN [EthanOllins] WITH DEFAULT_SCHEMA=[dbo]
GO
/****** Object:  User [AaronOpell]    Script Date: 6/29/2017 11:13:10 AM ******/
...
GO
/****** Object:  UserDefinedFunction [dbo].[assignCells]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Cells]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Games]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Grids]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Rooms]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Ships]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[Counts]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GROUP by Status
GO
/****** Object:  View [dbo].[HostList]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_addGuest]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
, Rooms.Host
, Rooms.Guest
from Users join Rooms
on Users.UserID = Rooms.Guest
where Users.UserID = @userID
GO
/****** Object:  StoredProcedure [dbo].[usp_addHost]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
DECLARE @UserID int
SET @UserID = (SELECT TOP 1 UserID FROM Users WHERE Name = @Username)
insert into Rooms values (@UserID, NULL, 0, @RoomName, 0, 0, NULL, NULL, NULL)
select Users.Name
, Users.UserID
, Rooms.Name
, Rooms.RoomID
...
GO
/****** Object:  StoredProcedure [dbo].[usp_addShip]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE procedure [dbo].[usp_addShip] @UserID int, @RoomID int, @GridID int, @CellID int, @Orientation int, @Length int, @status char(1)
as
declare @OriginX int;
...
GO
/****** Object:  StoredProcedure [dbo].[usp_assignCell]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[usp_Attack]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
select Status from Cells where CellID = @cellID


GO
/****** Object:  StoredProcedure [dbo].[usp_getAllAvailableRooms]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getAllAvailableRooms] 
as
select RoomID, Host, Name from Rooms where Status = 0
GO
/****** Object:  StoredProcedure [dbo].[usp_getCellByCoordinates]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getCellByCoordinates] @GridID int, @x int, @y int
as
select CellID from Cells where @GridID = GridID and X = @x and Y = @y
GO
/****** Object:  StoredProcedure [dbo].[usp_getCoordinatesByCell]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getCoordinatesByCell] @cellID int
as
select X, Y from Cells where @cellID = CellID
GO
/****** Object:  StoredProcedure [dbo].[usp_getGridOfUser]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getGridOfUser] @userID int
as
select GridID from Grids where UserID = @userID
GO
/****** Object:  StoredProcedure [dbo].[usp_getGuest]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getGuest] @roomID int
as
select Guest from Rooms where @roomID = RoomID

GO
/****** Object:  StoredProcedure [dbo].[usp_getHost]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getHost] @roomID int
as
select Host from Rooms where @roomID = RoomID
GO
/****** Object:  StoredProcedure [dbo].[usp_getIDByRoom]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getIDByRoom] @roomName varchar(50)
as
select RoomID from Rooms where @roomName = Name
GO
/****** Object:  StoredProcedure [dbo].[usp_getIDByUser]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getIDByUser] @username varchar(50)
as
select UserID from Users where @username = Name

grant EXEC ON usp_getIDByUser TO EthanOllinsAppUser

select * from Users
GO
/****** Object:  StoredProcedure [dbo].[usp_getRoomByID]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getRoomByID] @roomID int
as
select Name from Rooms where @roomID = RoomID
GO
/****** Object:  StoredProcedure [dbo].[usp_getRoomOfUser]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getRoomOfUser] @userID int
as
select Name, RoomID from Rooms where Host = @userID or Guest = @userID
GO
/****** Object:  StoredProcedure [dbo].[usp_getUserByID]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[usp_getUserByID] @userID int
as
select Name from Users where @userID = userID
GO
/****** Object:  StoredProcedure [dbo].[usp_insertCell]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
insert into Cells values (@GridID, @x, @y, @status)
GO
/****** Object:  StoredProcedure [dbo].[usp_toggleReady]    Script Date: 6/29/2017 11:13:10 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
begin
	...
	select P1Ready from Rooms where RoomID = @RoomID
end
else
begin
	update Rooms set P2Ready = 1 where RoomID = @RoomID
	select P2Ready from Rooms where RoomID = @RoomID
end
